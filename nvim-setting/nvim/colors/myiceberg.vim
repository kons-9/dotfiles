...
if &background == 'light'
  ...
  hi CursorLineNr cterm=NONE ctermbg=239 ctermfg=253 guibg=#2a3158 guifg=#cdd1e6
  ...
  hi IncSearch cterm=reverse ctermfg=NONE gui=reverse guifg=NONE term=reverse
  hi LineNr ctermbg=235 ctermfg=243 guibg=#1e2132 guifg=#444b71
  ...
  hi Visual ctermbg=238 ctermfg=NONE guibg=#272c42 guifg=NONE
